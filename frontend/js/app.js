...
function mqRenderIdentity() {
  ...
  const ecoleBloc = ce.isCommune
    ...
    : `<div class="acc-head"><span class="acc-pic">${mqGareEcolePic('ecole')}</span><span class="acc-title">À moins d'1,5 km d'une école</span><span class="src">BPE 2024 · Filosofi 2021</span></div>
  ...
  <div class="identity reveal">
    <div class="identity-top">
      ...
      <div class="identity-cell">
        <div class="cell-label">Densité de population</div>
